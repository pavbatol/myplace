...
На текущий момент реализована интеграция только с сервисами `security` и `profile/geo`. Подключение остальных микросервисов будет выполнено в следующих Pull Requests.
